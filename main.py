...
#        self._connectToGoogle()
        ...
        #self._uploadPicture(path) #comment out for offline version
...
#                     creds.refresh(Request())pis.com/v1/mediaItems:batchCreate', 
                ...
                json={
                    "albumId": "APc8FD6zwWrhgKVajmUI2z92BIaVKGlxoxqwuKIByE94TVephj6QOJ7mKaac2nCWcoHY-A_m3qgb",
                    "newMediaItems": [{
